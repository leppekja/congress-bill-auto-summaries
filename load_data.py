...
def build_vocab(training_data, summary_col, bill_col):
    '''
...
def get_dataloaders(batch_size, max_summary_length, max_bill_length, **kwargs):
    '''
    ...
    collate_fn = partial(
        collate_bills_fn, max_summary_length=max_summary_length, max_bill_length=max_bill_length)
...
def collate_bills_fn(batch, max_summary_length=512, max_bill_length=2048):
    '''
    ...
    for idx, text_dict in enumerate(batch):
        ...
        label_length = label_vectors.shape[0]
        text_length = text_vectors.shape[0]
        ...
        labels.append(label_vectors)
        texts.append(text_vectors)
